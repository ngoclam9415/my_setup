...
-- SELECT create_hypertable('sts_order', 'Date');
...
-- SELECT create_hypertable('sts_price', 'Date');
...
-- SELECT create_hypertable('sts_foreign_mo', 'Date');